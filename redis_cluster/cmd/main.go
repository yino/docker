...
func (r *Redis) Set(key string, value interface{}, expireTime time.Duration) (string, error) {
	return r.Cluster.Set(key, value, expireTime).Result()
}
func (r *Redis) Ping() (string, error) {
	return r.Cluster.Ping().Result()
}
...
func NewRedisCluster() Cache {
	Cluster := redis.NewClusterClient(&redis.ClusterOptions{
		...
		Addrs: []string{"10.96.65.220:6361", "10.96.65.220:6362", "10.96.65.220:6363", "10.96.65.220:6364", "10.96.65.220:6365", "10.96.65.220:6366"},
...
func main(){
	...
	fmt.Println(redisClu.Set("test_key","1008",0))
